      ...
      <div className="min-h-screen" style={{ backgroundColor: 'hsl(218,50%,12%)' }}>
        <div className="container mx-auto px-6 py-24 pt-32 max-w-3xl">
          ...
          <div className="space-y-6 text-white/70 text-sm leading-relaxed">
            <div>
              <h2 className="text-lg font-semibold text-white mb-2">Angaben gemäß § 5 DDG</h2>
              <p>
                Nexval GmbH<br />
            ...
            <div>
              ...
              <p>Umsatzsteuer-Identifikationsnummer gemäß § 27a UStG: beantragt, wird nach Erteilung ergänzt.</p>
            </div>
